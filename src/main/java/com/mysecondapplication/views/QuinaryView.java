...
public class QuinaryView extends View {
    ...
    public QuinaryView() {
        ...
        Label h1 = new Label("Firstly, thank you to Gluon for providing a free license for this project. Furthermore, I would like to thank the Gluon staff for answering all of my many questions. Similarly, I would also like to thank the creators of Java, JavaFX, computer science, and so forth for setting the precedent for people such as myself to discover the wonders of computer science. Also, I would like to give a huge shoutout and thank you to the Invisalign company for seeing my potential and awarding me with a generous grant to continue Therabot's development. Next, I want to extend a very special thank you to my grandfather, Arthur Goshtasby, PhD., for the immense amount of support during this project, as well as fostering my inital spark of interest in coding. Thirdly, thank you to my parents for all of the love and encouragement extended to me during the making of this project. I would also like to thank my friends for lifting me up during times when I felt discouraged. Lastly, I would especially like to thank you, the app user, for allowing my dream to become a reality. You are the reason why I keep going.");
